...
def _run_migrations_pg():
    new_columns = [
        ...
        ("projects",       "content_block",          "TEXT DEFAULT ''"),
        ("projects",       "content_block_position", "TEXT DEFAULT 'bottom'"),
        ("projects",       "project_type",           "TEXT DEFAULT 'keyword'"),
        ("projects",       "drive_folder_url",       "TEXT DEFAULT ''"),
        ("keyword_clusters", "youtube_source_id",    "INTEGER REFERENCES youtube_sources(id)"),
        ("recovery_tasks", "error_message",          "TEXT"),
        ...
        ("google_accounts", "token_error",            "TEXT"),
        ...
        ("index_tasks",    "was_indexed",            "BOOLEAN DEFAULT FALSE"),
...
def _run_migrations_sqlite():
    new_columns = [
        ...
        ("index_tasks",    "check_count",            "INTEGER DEFAULT 0"),
        ("index_tasks",    "sinbyte_task_id",        "TEXT"),
        ("index_tasks",    "was_indexed",            "INTEGER DEFAULT 0"),
        ("users",          "reset_token",            "TEXT"),
